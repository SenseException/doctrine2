...
class DDC1228Test extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testOneToOnePersist()
    {
        ...
        self::assertFalse($user->getProfile()->isProxyInitialized(), "Proxy is not initialized");
        $user->getProfile()->setName("Bar");
        self::assertTrue($user->getProfile()->isProxyInitialized(), "Proxy is not initialized");
